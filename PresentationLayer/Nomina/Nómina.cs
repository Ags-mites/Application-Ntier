...
using PresentationLayer.Nomina;
using System;
...
namespace PresentationLayer
{
    public partial class Nómina : Form
    {
        ...
        public void ReloadData()
        {
            ...
            var reportMotivosRepository = _socketListener.LoadDataMotivo("Load-MotivosRepository", null);
            var bindingSource = new BindingSource();
            bindingSource.DataSource = reportMotivosRepository;
        ...
        {
            var formEmpleado = new Workers(_socketListener);
            formEmpleado.FormClosed += (s, args) =>
            {
                ReloadData();
                this.Show();
            };
